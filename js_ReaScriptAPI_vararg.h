...
{
  JS_Window_Show((void*)arglist[0], (int)(intptr_t)arglist[1]);
  return NULL;
}
...
{
	JS_Window_ListAllChild((void*)arglist[0], (double*)arglist[1]); // (const char*)arglist[1], (const char*)arglist[2]);
  return NULL;
}

static void* __vararg_JS_Window_ListAllTop(void** arglist, int numparms)
{
	JS_Window_ListAllTop((double*)arglist[0]); // (const char*)arglist[0], (const char*)arglist[1]);
  return NULL;
}

static void* __vararg_JS_Window_ListFind(void** arglist, int numparms)
{
	JS_Window_ListFind((const char*)arglist[0], (bool)arglist[1], (double*)arglist[2]); // (const char*)arglist[2], (const char*)arglist[3]);
  return NULL;
}

static void* __vararg_JS_MIDIEditor_ListAll(void** arglist, int numparms)
{
	JS_MIDIEditor_ListAll((double*)arglist[0]); // (char*)arglist[0], (int)(intptr_t)arglist[1]);
  return NULL;
}
...
static void* __vararg_JS_Window_GetInfoPtr(void** arglist, int numparms)
{
	return JS_Window_GetInfoPtr((void*)arglist[0], (const char*)arglist[1]);
}
...
{
	JS_LICE_DrawChar((void*)arglist[0], (int)(INT_PTR)arglist[1], (int)(INT_PTR)arglist[2], (char)(intptr_t)arglist[3], (int)(INT_PTR)arglist[4], arglist[5] ? *(double*)arglist[5] : 0.0, (int)(INT_PTR)arglist[6]);
	return NULL;
}

static void* __vararg_JS_LICE_FillRect(void** arglist, int numparms)
{
	JS_LICE_FillRect((void*)arglist[0], (int)(INT_PTR)arglist[1], (int)(INT_PTR)arglist[2], (int)(INT_PTR)arglist[3], (int)(INT_PTR)arglist[4], (int)(INT_PTR)arglist[5], arglist[6] ? *(double*)arglist[6] : 0.0, (int)(INT_PTR)arglist[7]);
	return NULL;
}

static void* __vararg_JS_LICE_FillTriangle(void** arglist, int numparms)
{
	JS_LICE_FillTriangle((void*)arglist[0], (int)(INT_PTR)arglist[1], (int)(INT_PTR)arglist[2], (int)(INT_PTR)arglist[3], (int)(INT_PTR)arglist[4], (int)(INT_PTR)arglist[5], (int)(INT_PTR)arglist[6], (int)(INT_PTR)arglist[7], arglist[8] ? *(double*)arglist[8] : 0.0, (int)(INT_PTR)arglist[9]);
	return NULL;
}

static void* __vararg_JS_LICE_FillPolygon(void** arglist, int numparms)
{
	JS_LICE_FillPolygon((void*)arglist[0], (const char*)arglist[1], (const char*)arglist[2], (int)(INT_PTR)arglist[3], (int)(INT_PTR)arglist[4], arglist[5] ? *(double*)arglist[5] : 0.0, (int)(INT_PTR)arglist[6]);
	return NULL;
}

static void* __vararg_JS_LICE_FillCircle(void** arglist, int numparms)
{
	JS_LICE_FillCircle((void*)arglist[0], arglist[1] ? *(double*)arglist[1] : 0.0, arglist[2] ? *(double*)arglist[2] : 0.0, arglist[3] ? *(double*)arglist[3] : 0.0, (int)(INT_PTR)arglist[4], arglist[5] ? *(double*)arglist[5] : 0.0, (int)(INT_PTR)arglist[6], (bool)arglist[7]);
	return NULL;
}

static void* __vararg_JS_LICE_Line(void** arglist, int numparms)
{
	JS_LICE_Line((void*)arglist[0], arglist[1] ? *(double*)arglist[1] : 0.0, arglist[2] ? *(double*)arglist[2] : 0.0, arglist[3] ? *(double*)arglist[3] : 0.0, arglist[4] ? *(double*)arglist[4] : 0.0, (int)(INT_PTR)arglist[5], arglist[6] ? *(double*)arglist[6] : 0.0, (int)(INT_PTR)arglist[7], (bool)arglist[8]);
	return NULL;
}

static void* __vararg_JS_LICE_Arc(void** arglist, int numparms)
{
	JS_LICE_Arc((void*)arglist[0], arglist[1] ? *(double*)arglist[1] : 0.0, arglist[2] ? *(double*)arglist[2] : 0.0, arglist[3] ? *(double*)arglist[3] : 0.0, arglist[4] ? *(double*)arglist[4] : 0.0, arglist[5] ? *(double*)arglist[5] : 0.0, (int)(INT_PTR)arglist[6], arglist[7] ? *(double*)arglist[7] : 0.0, (int)(INT_PTR)arglist[8], (bool)arglist[9]);
	return NULL;
}

static void* __vararg_JS_LICE_Circle(void** arglist, int numparms)
{
	JS_LICE_Circle((void*)arglist[0], arglist[1] ? *(double*)arglist[1] : 0.0, arglist[2] ? *(double*)arglist[2] : 0.0, arglist[3] ? *(double*)arglist[3] : 0.0, (int)(INT_PTR)arglist[4], arglist[5] ? *(double*)arglist[5] : 0.0, (int)(INT_PTR)arglist[6], (bool)arglist[7]);
	return NULL;
}

static void* __vararg_JS_LICE_RoundRect(void** arglist, int numparms)
{
	JS_LICE_RoundRect((void*)arglist[0], arglist[1] ? *(double*)arglist[1] : 0.0, arglist[2] ? *(double*)arglist[2] : 0.0, arglist[3] ? *(double*)arglist[3] : 0.0, arglist[4] ? *(double*)arglist[4] : 0.0, (int)(INT_PTR)arglist[5], (int)(INT_PTR)arglist[6], arglist[7] ? *(double*)arglist[7] : 0.0, (int)(INT_PTR)arglist[8], (bool)arglist[9]);
	return NULL;
}
...
{
	JS_LICE_PutPixel((void*)arglist[0], (int)(INT_PTR)arglist[1], (int)(INT_PTR)arglist[2], (int)(INT_PTR)arglist[3], arglist[4] ? *(double*)arglist[4] : 0.0, (int)(INT_PTR)arglist[5]);
	return NULL;
}
