...
APIdef aAPIdefs[] =
{
	...
	{ APIFUNC(JS_Window_MonitorFromRect), "void", "int,int,int,int,bool,int*,int*,int*,int*", "x1,y1,x2,y2,wantWork,leftOut,topOut,rightOut,bottomOut", "", },
	...
	{ APIFUNC(JS_Window_GetLongPtr), "void*", "void*,const char*,double*", "windowHWND,info,integerOut", "Returns information about the specified window.\n\ninfo: \"USERDATA\", \"WNDPROC\", \"DLGPROC\", \"ID\", \"EXSTYLE\" or \"STYLE\".\n\nFor documentation about the types of information returned, refer to the Win32 function GetWindowLongPtr.\n\nNOTES:\nSince the values returned by \"DLGPROC\" and \"WINPROC\" are used as pointers, whereas the others are used as integers, this function provides all return values as both pointers and integers."},
