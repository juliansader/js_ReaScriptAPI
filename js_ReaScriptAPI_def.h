...
APIdef aAPIdefs[] =
{
	...
	{ APIFUNC(JS_Localize), "const char*", "const char*,const char*", "USEnglish,LangPackSection", "Returns the translation of the given US English text, according to the currently loaded Language Pack.\n\nParameters:\n * LangPackSection: Language Packs are divided into sections such as \"common\" or \"DLG_102\".", },
	...
	{ APIFUNC(JS_PtrFromStr), "void*", "const char*", "str", "", },
	...
	{ APIFUNC(JS_ListView_GetFocusedItem), "int", "void*,char*,int", "listviewHWND,textOut,textOut_sz", "", },
	...
	{ APIFUNC(JS_ListView_GetItem), "void", "void*,int,char*,int,int*", "listviewHWND,index,textOut,textOut_sz,stateOut", "Return the text and state of specified item. ", },
	{ APIFUNC(JS_ListView_ListAllSelItems), "int", "void*,char*,int", "listviewHWND,itemsOutNeedBig,itemsOutNeedBig_sz", "Returns the indices of all selected items as a comma-separated list.\n\n * retval: Number of selected itmes found; negative or zero if an error occured.", },
