...
APIdef aAPIdefs[] =
{
	...
	//{ APIFUNC(JS_Dialog_Create), "void*", "int", "resourceID", "", },
	...
	{ APIFUNC(JS_Window_Find), "void*", "const char*,bool", "title,exact", "Similar to the Win32 function FindWindow, this function returns a HWND to the top-level window whose title matches the specified string, does not search child window, and is not case sensitive. Unlike FindWindow, can optionally match substrings of the title.\n\nParameters:\n * exact: Match entire title exactly, or match substring of title.", },
	{ APIFUNC(JS_Window_FindAny), "void*", "const char*,bool", "title,exact", "Returns a HWND to a window whose title matches the specified string. This function searches top-level as well as child windows, and is not case sensitive.\n\nParameters:\n * exact: Match entire title exactly, or match substring of title.", },
